...
// synctang: on-demand LUKS unlocker with a human-operated key holder.
...
replace syncthing-socket => github.com/muelli/syncthing-socket v0.1.1-alpha.0.20260909182828-518875db93fe
